...
const Footer = () => {
  return (
    <footer className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto text-white-200 dark:bg-neutral-900 dark:text-neutral-400">
      <div className="text-center">
        ...
        <div className="mt-3">
          <p className="text-gray-500 dark:text-neutral-500">San Martín 890 - 2°piso | San Miguel de Tucumán | Argentina</p>
        ...
        <div className="mt-3 flex justify-center space-x-2  ">
          <a target="_blank" className="w-8 h-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-500 hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="https://www.instagram.com/lopezriosconsultora/">
            <svg className="shrink-0 size-3.5 w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a target="_blank" className="w-8 h-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-500 hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href="https://www.facebook.com/people/LOPEZ-RIOS-Consultora/100063482303475/">
            <svg className="shrink-0 size-3.5 w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">

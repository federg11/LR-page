...
const Card = () => {
  return (
    <main id="nosotros" className="min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh] lg:min-h-dvh bg-red-800 text-neutral-900 dark:text-neutral-100 p-4 sm:p-6 scroll-mt-20">
